...
const Footer = () => {
  return (
    <footer className="bg-amora-darkBrown text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-gray-300 mb-4">
              Amora Marketplace - A melhor plataforma para compra e venda de produtos exclusivos.
            </p>
            <div className="flex space-x-4">
              {/* Social Icons */}
              <a href="#" className="hover:text-amora-beige transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li className="flex items-start space-x-2">
                ...
                <span>Rua da Amora, 123, São Paulo - SP</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>contato@amora.com.br</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-gray-700 mt-10 pt-6 text-sm text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Amora Marketplace. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
